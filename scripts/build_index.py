...
def main():
    ...
    vectors = np.load(vectors_path).astype('float32')  # shape = (58000, 512)

    print("加载向量:", vectors.shape)
    
    # 2. 创建IVF索引（示例：IVF_FLAT）
    d = vectors.shape[1]  # 512
    ...
    #metadata_path = "/Users/zhu_yangyang/Desktop/UkiyoeSearch_Project/ukiyoe_dataset/index/metadata.csv"  
